...
export default function Home() {
  return <main>
    <section className="home-hero">
      <div className="hero-copy"><p className="eyebrow">COWBOY-BUILT · ROOFER-SMART</p><h1>A better roof.<br/><em>Built your way.</em></h1><p>Expert material logic, clear planning tools, and a hands-on crew—from the home over your head to the biggest roof in the skyline.</p><div className="actions"><Link className="primary" href="/roof-advisor">ASK THE ROOF ADVISOR <span>→</span></Link><Link className="text-link" href="/customize">CUSTOMIZE YOUR ROOF</Link></div></div>
    ...
    <section className="promise-strip"><span>FREE INSPECTION</span><i>✦</i><span>SMART ROOF ADVISOR</span><i>✦</i><span>PREMIUM MATERIAL SYSTEMS</span><i>✦</i><span>COWBOY FOLLOW-THROUGH</span></section>
    <section className="expert-teaser shell"><div><p className="eyebrow light">NEW / COWBOY ROOF INTELLIGENCE</p><h2>Six roof facts.<br/>One smarter starting point.</h2><p>Age, symptoms, slope, attic, tree cover, and priorities become a complete system recommendation—not just a shingle color.</p><Link href="/roof-advisor">RUN MY ROOF READOUT →</Link></div><div className="teaser-readout"><span><small>ROOF SIGNAL</small>PLANNING AHEAD</span><span><small>EXPERT MATCH</small>CLASS 4 SYSTEM</span><span><small>CLIMATE LOGIC</small>HEAT · WIND · RAIN</span><b>LIVE RECOMMENDATION</b></div></section>
