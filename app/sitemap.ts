...
export default function sitemap(): MetadataRoute.Sitemap {
  const routes = ['', '/directory', '/roofing', '/shop', '/company', '/free-inspection', '/neighbors', ...neighborCities.map((city) => `/neighbors/${city.slug}`), '/share', '/growth', '/leads', '/network', '/operations', '/roof-replacement', '/roof-repair', '/storm-damage', '/commercial-roofing', '/transformations', '/roof-systems', '/performance-upgrades', '/field-goods', '/library', ...libraryFiles.map((file) => `/library/${file.slug}`), '/service-areas', '/service-areas/alpharetta', '/service-areas/roswell', '/service-areas/milton', '/service-areas/johns-creek', '/service-areas/cumming', '/services', '/quality', '/start', '/roof-advisor', '/customize', '/guides', '/marketplace', '/project-center', '/legal', '/terms', '/privacy', '/accessibility'];
