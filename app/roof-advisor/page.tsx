...
export default function RoofAdvisorPage() {
  ...
  return <main className="advisor-page">
    ...
    <section className="advisor-final"><p className="eyebrow">FROM SMART PLAN TO FIELD TRUTH</p><h2>Let the roof tell us<br/>what it needs.</h2><div><Link className="primary" href="/services#inspection">START WITH A FREE INSPECTION →</Link><Link className="text-link" href="/guides">READ THE EASY GUIDES</Link></div></section>
  </main>;
}
