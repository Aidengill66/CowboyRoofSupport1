...
export function LocalLanding({ city, headline, intro, localNotes }: LocalLandingProps) {
  return <main className="local-landing">
    ...
    <section className="final-cta"><p className="eyebrow">READY IN {city.toUpperCase()}?</p><h2>Start with the roof.</h2><a className="primary" href="/free-inspection">REQUEST A FREE INSPECTION <span>→</span></a></section>
  </main>;
}
