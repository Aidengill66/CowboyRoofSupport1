...
const groups = [
  { label: 'Roofing', links: [['Smart Roof Advisor', '/roof-advisor'], ['Services', '/services'], ['Customize your roof', '/customize'], ['Blueprints & guides', '/guides']] },
...
export function SiteFooter() {
  return <footer className="footer"><div className="footer-main">
    ...
    <div><small>ROOFING</small><Link href="/roof-advisor">Smart Roof Advisor</Link><Link href="/customize">Customize</Link><Link href="/services">Services</Link><Link href="/guides">Guides</Link></div>
